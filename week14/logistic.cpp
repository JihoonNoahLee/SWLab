...
void generate_2d_gaussian_data(MatrixXf* mat_X, MatrixXd* mat_T, int patterns, int len, float mean1, float mean2, float var);
...
int	main(void)
{
	...
	//Generate 2dimensional Gaussian Data
